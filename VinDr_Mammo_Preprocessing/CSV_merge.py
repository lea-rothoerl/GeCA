...
df3 = df3[["image_id", "finding_categories", "xmin", "ymin", "xmax", "ymax"]] 

df_merged = df1.merge(df2, left_on="image_id", right_on="SOP Instance UID", how="left").drop(columns=["SOP Instance UID"])

df_merged = df_merged.merge(df3, on="image_id", how="left")
